I'll put my atomic notes and my idea notes in this folder. If I tag them with `#atomic` then I can search that tag, hit the copy -> with markdown links, and paste the results here
